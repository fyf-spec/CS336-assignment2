...
Usage examples:
    ...
    python -m cs336_systems.memory_profiling --context-length 128 --mode forward

    # Full training step, context length 512, mixed precision
    python -m cs336_systems.memory_profiling --context-length 512 --mode train --mixed-precision

    # Custom output filename
    python -m cs336_systems.memory_profiling --context-length 256 --mode train -o my_snapshot.pickle
"""
